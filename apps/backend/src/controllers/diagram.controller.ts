 ...
 */
export const createDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
...
export const getDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const listDiagrams = async (req: any, res: Response, next: NextFunction) => {
  try {
...
export const updateDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const restoreDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const starDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const unstarDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const createShareLink = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const getPublicDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
...
export const quickSave = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const saveVersion = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
    const { name } = req.body;
    const diagram = await Diagram.findById(id);
...
export const getVersions = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
    const diagram = await Diagram.findById(id);
    if (!diagram) throw new ApiError(404, 'NOT_FOUND', 'Diagram not found');
...
export const restoreVersion = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id, versionId } = req.params;
...
export const duplicateDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const trashDiagram = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
    await diagramService.moveToTrash(id, req.userId);
    res.json({ success: true, message: 'Diagram moved to trash' });
...
export const revokeShareLink = async (req: any, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
