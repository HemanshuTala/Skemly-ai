...
import {
  ...
  Calendar, Clock, Timer, Stopwatch, Watch, Sun, Moon, Cloud as CloudIcon,
  CloudRain, Wind, Thermometer, Droplets, Flame, Snowflake,
  Home, Building, Factory, Warehouse, Store, School, Hospital, Banknote,
  ...
  Trash2, Archive, ArchiveRestore, Unarchive, Save, Download, Upload,
  ...
  MemoryStick, Disc, Usb, Wifi as WifiIcon, Ethernet, Bluetooth as BTIcon,
  ...
  Cloudy, CloudFog, CloudLightning, CloudMoon, CloudSun, Haze, Mist,
  Tornado, Hurricane, Earthquake, Flood, Tsunami, Volcano, FireExtinguisher,
  FireHydrant, Siren, Megaphone, Speaker as SpeakerIcon, VolumeOff,
  Headphones as HeadphonesIcon, Headset, Watch as WatchIcon, Glasses,
  Sunglasses, Shirt, ShoppingBag as BagIcon, Tag as TagIcon,
  ...
  Hash, At, Pound, DollarSign, Euro, PoundSterling, JapaneseYen, RussianRuble,
  IndianRupee, PhilippinePeso, Bitcoin, CreditCard as CardIcon, Wallet as WalletIcon,
  Banknote as CashIcon, Receipt as ReceiptIcon, Invoice, File as FileIcon,
  ...
  ClipboardType, ClipboardX, StickyNote, Sticker, Square, SquareCheck,
  SquareDashed, SquareDot, SquareMinus, SquarePlus, SquareSlash,
  ...
  Trophy as TrophyShape, Flag as FlagShape, FlagTriangle, FlagPennant,
  Bookmark as BookmarkIcon, BookOpen, Book, BookX, BookCheck, BookMarked,
  Library, GraduationCap, School as SchoolIcon, University, Building as BuildingIcon,
  Building2, Home as HomeIcon, House, Warehouse as WarehouseIcon, Store as StoreIcon,
  StoreIcon as ShopIcon, Factory as FactoryIcon, Hospital as HospitalIcon,
  Hotel, Castle, Church, Temple, Mosque, Synagogue, Landmark, Monument,
  ...
  ChefHat, Armchair, Bed, Bath, ShowerHead, Toilet, Sink, LampFloor,
  LampCeiling, LampWallDown, LampDesk, Fan, AirVent, Thermometer as TempIcon,
  Heater, Cooler, WashingMachine, Fridge, Microwave, Oven, Dishwasher,
  Blender, CoffeeMaker, Iron, Vacuum, Fan as FanIcon, AirVent as VentIcon,
  ...
  Usb as USBIcon, Wifi as WifiSignal, Ethernet as EthIcon, Bluetooth as BluetoothIcon,
  ...
  Pointer, Grab, Hand, HandMetal, HelpingHand, RockingHand, ThumbsUp as ThumbUp,
  ThumbsDown as ThumbDown, Peace, Smile, Frown, Meh, Laugh, Annoyed,
  Angry, Dizzy, Ghost, Skull, Bot, BotMessageSquare, BotIcon as RobotIcon,
  ...
  CloudDownload, CloudUpload, CloudRainWind, CloudSunRain,
  CloudMoonRain, CloudLightning as StormIcon, Tornado as TornadoIcon,
  Hurricane as HurricaneIcon, Snowflake as SnowIcon2, Flame as Fire,
  Droplet, Droplets as RainDrops, Waves as WaveIcon, Wind as Breeze,
  Tornado as Twister, Thermometer as ThermoIcon, Gauge as GaugeIcon,
  Activity as PulseIcon, Heart as HeartBeat, Stethoscope, Syringe,
  Capsule, Tablet as PillIcon, Thermometer as TempMeter,
  ...
  Watch as SmartWatch, Glasses as Spectacles, Sunglasses as Shades,
  ...
  HelpingHand as HelpHand, RockingHand as RockHand, Peace as PeaceIcon,
  Smile as Happy, Frown as Sad, Meh as Neutral, Laugh as Laughing,
  Annoyed as AnnoyedIcon, Angry as AngryIcon, Dizzy as DizzyIcon,
  ...
  CloudCog as CloudSettings, CloudDownload as CloudDL, CloudUpload as CloudUL,
  CloudRainWind as Storm, CloudSunRain as SunRain,
  CloudMoonRain as MoonRain, CloudLightning as Thunder, Tornado as Cyclone,
  Hurricane as Typhoon, Snowflake as Frost, Flame as Blaze, Droplet as Drop,
  ...
  Capsule as CapPill, Pills as Meds,
  ...
  Glasses as Eyeglasses, Sunglasses as SunGlasses,
  ...
  HelpingHand as Helper, RockingHand as RockOn, Peace as Victory,
  Smile as Grin, Frown as FrownIcon, Meh as MehIcon, Laugh as Lol,
  Annoyed as Ugh, Angry as Mad, Dizzy as Confused, Ghost as Spooky,
  ...
  CloudCog as CloudConfig, CloudDownload as DownloadCloud,
  CloudUpload as UploadCloud, CloudRainWind as WindyRain,
  CloudSunRain as PartlyRainy, CloudMoonRain as NightRain,
  CloudLightning as LightningStorm, Tornado as TornadoWind,
  Hurricane as HurricaneWind, Snowflake as Snow,
  ...
  Capsule as Drug, Tablet as TabletMed, Pills as Drugs,
